		...
		public var startColour = 3;
		public var timeDirCon:Array;*/
		...
		/*private function genPathCon(): void {
			...
			for (i = 0; i < charDir.length; i++) {
				...
				pathCon[i].x = stage.stageWidth/(charDir.length + 1) * (i + 1);
				pathCon[i].y = 600;
				addChild(pathCon[i]);
			}
		}*/
		...
		/*private function genTimeCon(): void {
			timeDirCon = new Array();
			var i:uint;
			for (i = 0; i < charDir.length; i++) {
				timeDirCon.push(new SeqToggle(i));
				timeDirCon[i].x = pathCon[i].x;
				timeDirCon[i].y = pathCon[i].y;
				addChild(timeDirCon[i]);
			}
		}*/
		...
		Main.prototype.genSequence = function(paths, moves) {
			...
			/*timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(0);
			timeDir[timeDir.length - 1][1].push(0, 0);
			timeDir[timeDir.length - 1][2].push(1);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(1);
			timeDir[timeDir.length - 1][1].push(0, 0);
			timeDir[timeDir.length - 1][2].push(2);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(2);
			timeDir[timeDir.length - 1][1].push(0, 0);
			timeDir[timeDir.length - 1][2].push(3);
			...
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(0);
			timeDir[timeDir.length - 1][1].push(0, 1);
			timeDir[timeDir.length - 1][2].push(0);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(1);
			timeDir[timeDir.length - 1][1].push(0, 2);
			timeDir[timeDir.length - 1][2].push(0);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(2);
			timeDir[timeDir.length - 1][1].push(0, 3);
			timeDir[timeDir.length - 1][2].push(0);
			...
			timeDir[timeDir.length - 1][0].push(0);
			timeDir[timeDir.length - 1][1].push(0, 3);
			timeDir[timeDir.length - 1][2].push(5);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			...
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(1);
			timeDir[timeDir.length - 1][1].push(1, 1);
			timeDir[timeDir.length - 1][2].push(4);
			...
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(1);
			timeDir[timeDir.length - 1][1].push(3, 3);
			timeDir[timeDir.length - 1][2].push(3);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1][0].push(2);
			timeDir[timeDir.length - 1][1].push(2, 2);
			timeDir[timeDir.length - 1][2].push(2);
			timeDir.push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
			timeDir[timeDir.length - 1].push(new Array());
